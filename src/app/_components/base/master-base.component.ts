...
@Injectable()
export abstract class MasterBaseComponent extends AppPageBaseComponent {
    ...
    activationOptions: SelectItem[];

    table: Table;

    constructor(public override notifService: NotificationService) {
        super(notifService);
